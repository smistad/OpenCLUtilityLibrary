...
ELSE (APPLE)
	...
	IF (WIN32)
        ...
        IF( ${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64" ) #64 bit
            IF(EXISTS $ENV{ATISTREAMSDKROOT}) #ati
                SET(OPENCL_LIB_DIR "$ENV{ATISTREAMSDKROOT}/lib/x86_64")
            ELSEIF(EXISTS $ENV{CUDA_PATH}) #nvidia
                SET(OPENCL_LIB_DIR "$ENV{CUDA_PATH}/lib/x64")
            ENDIF()
        ELSE (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "AMD64") #32 bit
            IF($ENV{ATISTREAMSDKROOT}) #ati
                SET(OPENCL_LIB_DIR "$ENV{ATISTREAMSDKROOT}/lib/x86")
            ELSEIF($ENV{CUDA_PATH}) #nvidia
	...
	ELSE (WIN32)
		...
		FIND_LIBRARY(OPENCL_LIBRARIES OpenCL
			PATHS ENV LD_LIBRARY_PATH ENV OpenCL_LIBPATH "/usr/local/cuda/lib64"
		)
